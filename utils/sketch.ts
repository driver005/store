...
class Sketch {
    ...
    constructor(opts: { fragment: any; uniforms: any; duration: number; debug: boolean; easing: 'easeIn' | 'easeOut' | 'easeInOut'; }) {
    ...
    initiate(cb: { (): void; (): void; }) {
        const promises: any[] = [];
        let that = this;
        this.images.forEach((url: string, i: any) => {
    ...
    addObjects() {
        this.material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                displacement: { value: new THREE.TextureLoader().load(map.src) },
