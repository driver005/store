...
const CheckoutTemplate = () => {
    return (
        <CheckoutProvider>
            <div className="bg-gray-100 relative sm:min-h-screen">
                    ...
                    <nav className="flex items-center h-full justify-between content-container">
                        <Link href="/cart">
                            <a className="text-small-semi text-gray-700 flex items-center gap-x-2 uppercase flex-1 basis-0">
                                ...
                                <span className="mt-px block sm:hidden">
                                    Back
                                </span>
                            </a>
                        </Link>
                ...
                <div className="relative">
                    <CheckoutLoader />
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_416px] gap-y-8 content-container gap-x-8 py-12">
                        <CheckoutForm />
                        <CheckoutSummary />
                    </div>
                </div>
