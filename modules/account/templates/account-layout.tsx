...
const AccountLayout: React.FC<{ children: React.ReactNode }> = ({
    ...
    return (
        <div className="flex-1 sm:py-12 sm:bg-gray-50">
            <div className="flex-1 h-full max-w-5xl mx-auto bg-white flex flex-col">
                <div className="grid grid-cols-1 sm:grid-cols-[240px_1fr] px-4 sm:px-8 py-6 sm:py-12 ">
                    <div>
                        <AccountNav />
                    </div>
                    <div className="flex-1">{children}</div>
                </div>
                <div className="flex flex-col sm:flex-row items-end justify-between sm:border-t border-gray-200 px-8 py-12 gap-x-8">
                    <div>
