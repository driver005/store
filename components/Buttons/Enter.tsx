...
export const ButtonTextCircle: React.FC<ButtonProps> = ({ label, height, onClick, className, type = 'button', scale = true, loaded = true, color = '#000' }) => {
    return (
        <Skeleton
            w='fit-content'
            isLoaded={loaded}
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <chakra.textPath letterSpacing='17px' href="#textcircle" aria-label={label} textLength="900">
                            {label}
                        </chakra.textPath>
                    </chakra.text>
                </chakra.svg>
