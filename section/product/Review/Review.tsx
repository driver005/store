...
const ProductReview: React.FC<ProductReviewProps> = ({ setOpen, product, button = true }) => {
    return (
        <Stack
            w='full'
            mb='10'
        ...
        >
            ...
            <Stars
                stars={5}
                rating={3.5}
                label={"Based on 1600 reviews"}
            />
            <Stack spacing='0.5' pb='2'>
                <HStack spacing='3' alignItems='center'>
                    <HStack spacing='3'>
                        <Text fontWeight='500'>5</Text>
                        <Icon as={BsStarFill} className='!text-yellow-400' w={4} h={4} />
                    </HStack>
            ...
            {button && <ButtonBestia label='See all' height={10} onClick={() => setOpen(true)} scale={false} />}
        </Stack>
