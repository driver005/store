...
const Heading: FC<HeadingProps> = ({
    ...
    const top = useBreakpointValue({ base: '1rem', lg: '2rem' }, { fallback: 'lg' })
    const left = useBreakpointValue({ base: '1rem', lg: '3rem' }, { fallback: 'lg' })
    const right = useBreakpointValue({ base: '1rem', lg: '3rem' }, { fallback: 'lg' })
    const bottom = useBreakpointValue({ base: '1rem', lg: '2rem' }, { fallback: 'lg' })
    let tl: any = null
    ...
    const expandMenu = useCallback(() => {
        ...
        var node = ReactDOM.findDOMNode(document.querySelector('.wrapper')) as HTMLInputElement;
