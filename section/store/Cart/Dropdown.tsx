import { Box, Button, chakra, Flex, Grid, Icon, Popover, PopoverContent, PopoverHeader, PopoverTrigger, Text, VisuallyHidden } from "@chakra-ui/react"
            ...
            <Popover>
                ...
                <PopoverContent minW='xs' w='none'>
                    <Flex
                        ...
                        p='4'
                    >
                        <Text as='h3' fontSize='medium' fontWeight='semibold'>Shopping Bag</Text>
                    </Flex>
                    {cart && items?.length ? (
                        <>
                            <Grid
                            ...
                            >
                                <Flex alignItems='center' justifyContent='space-between'>
                                    <chakra.span color='gray.700' fontWeight='semibold'>
                                        Subtotal{" "}
                                        <chakra.span fontWeight='400'>(incl. taxes)</chakra.span>
                                    </chakra.span>
                                ...
                                <Link href="/cart" passHref>
                                    <a>
                                        <ButtonBestia label='Go to bag' height={10} />
                                    </a>
                                </Link>
                            </Flex>
                        </>
                        ...
                        <Box>
                            ...
                            >
                                ...
                                <div>
                                    <Link href="/">
                                        <a>
                                            <VisuallyHidden>Go to all products page</VisuallyHidden>
