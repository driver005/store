...
const Intro: React.FC<IntroProps> = ({}) => {
    ...
    const wrapperRow = useBreakpointValue({
        base: '4rem min-content min-content 1rem auto 1fr',
        lg: '32% 15% 35% 18%',
    })
    const wrapperArea = useBreakpointValue({
        base: "'...' 'title-up' 'title-down' '...' 'image' '...'",
        lg: '"title-up" "title-down"  "image" "."',
    })
    ...
    const showIntro = () => {
        ...
        gsap.timeline({
            ...
            .set(
                [up.current.childNodes, down.current.childNodes],
                {
                    opacity: 0,
                },
                'start'
